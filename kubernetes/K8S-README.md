...
```
$ docker image tag transaminvoice transam/transaminvoice
$ docker push transam/transaminvoice
$ docker image tag transamnotification transam/transamnotification
$ docker push transam/transamnotification
$ docker image tag transamstore transam/transamstore
$ docker push transam/transamstore
$ docker image tag transambackoffice transam/transambackoffice
$ docker push transam/transambackoffice
```
...
```
$ kubectl get svc transaminvoice
$ kubectl get svc transamnotification
$ kubectl get svc transamstore
$ kubectl get svc transambackoffice
```
