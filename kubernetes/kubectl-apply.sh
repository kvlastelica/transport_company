...
default() {
    ...
    kubectl apply -f transaminvoice-${suffix}/
    kubectl apply -f transamnotification-${suffix}/
    kubectl apply -f transamstore-${suffix}/
    kubectl apply -f transambackoffice-${suffix}/
