package com.transam.invoice.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.transam.invoice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.transam.invoice.security.DomainUserDetailsService", "createSpringSecurityUser");
