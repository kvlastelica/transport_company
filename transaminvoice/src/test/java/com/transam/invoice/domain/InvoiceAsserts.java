...
import static com.transam.invoice.domain.AssertUtils.bigDecimalCompareTo;
...
public class InvoiceAsserts {
    ...
    public static void assertInvoiceUpdatableFieldsEquals(Invoice expected, Invoice actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getTicketOrderCode()).as("check ticketOrderCode").isEqualTo(expected.getTicketOrderCode()))
