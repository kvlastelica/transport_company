...
describe('Invoice Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '00534f4a-d1bb-4b05-8476-4d620d9e3478' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'e66ae3f4-b0b0-407d-b3b3-7920e9204576' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.invoices()[0]).toEqual(expect.objectContaining({ id: '00534f4a-d1bb-4b05-8476-4d620d9e3478' }));
  });

  describe('trackId', () => {
    it('Should forward to invoiceService', () => {
      const entity = { id: '00534f4a-d1bb-4b05-8476-4d620d9e3478' };
