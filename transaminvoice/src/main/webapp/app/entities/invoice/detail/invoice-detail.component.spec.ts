...
describe('Invoice Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { invoice: () => of({ id: '00534f4a-d1bb-4b05-8476-4d620d9e3478' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load invoice on init', async () => {
      ...
      // THEN
      expect(instance.invoice()).toEqual(expect.objectContaining({ id: '00534f4a-d1bb-4b05-8476-4d620d9e3478' }));
    });
  });
