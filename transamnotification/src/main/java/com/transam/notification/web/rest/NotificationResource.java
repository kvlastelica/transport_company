...
/**
 * REST controller for managing {@link com.transam.notification.domain.Notification}.
 */
@RestController
...
public class NotificationResource {
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<Notification>> getNotification(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteNotification(@PathVariable("id") String id) {
