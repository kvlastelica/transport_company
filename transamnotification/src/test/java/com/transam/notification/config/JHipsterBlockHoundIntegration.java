package com.transam.notification.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.transam.notification.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.transam.notification.security.DomainUserDetailsService", "createSpringSecurityUser");
