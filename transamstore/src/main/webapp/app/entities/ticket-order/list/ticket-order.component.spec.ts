...
import { sampleWithRequiredData } from '../ticket-order.test-samples';
...
describe('TicketOrder Management Component', () => {
  let comp: TicketOrderComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TicketOrderComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ticketOrders()[0]).toEqual(expect.objectContaining({ id: 29317 }));
  });

  describe('trackId', () => {
    it('Should forward to ticketOrderService', () => {
      const entity = { id: 29317 };
      jest.spyOn(service, 'getTicketOrderIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTicketOrderIdentifier).toHaveBeenCalledWith(entity);
