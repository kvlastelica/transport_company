package com.transam.backoffice.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.transam.backoffice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.transam.backoffice.security.DomainUserDetailsService", "createSpringSecurityUser");
